...
describe("Article component", () => {
    ...
    it("should render detail view", () => {
        ...
        expect(container.querySelector("[data-cy=pullQuote]").textContent).toBe(content.fields.pullQuote);
        expect(container.querySelector("div.MuiBox-root a").href).toContain(`/profile/${content.fields.author.fields.slug}`);
        expect(container.querySelector("[data-cy=author]").textContent).toContain(content.fields.author.fields.name);
