...
export declare interface ISmartCaptureConfiguration {
    /**
     * The distance around the edge as a percentage of the image dimensions
     * which will cause an image to be rejected. Increase this to require the
     * identity document to be more centralised.
     *
     * @defaultValue 0.025
     *
     * @public
    ...
    /**
     * How many attempts should be made to capture a valid image before
     * stopping.
     *
     * @defaultValue 100
     *
    ...
    /**
     * How stringent are the validation checks on the images captured by the
...
export declare class LanguageService {
    ...
    setDictionary: (dictionary?: Partial<Record<TranslationKey, string>> | undefined) => {
        ...
        PROVIDER_TITLE_FILESYSTEM: string;
...
export declare enum TranslationKey {
    ...
    PROVIDER_TITLE_FILESYSTEM = "PROVIDER_TITLE_FILESYSTEM",
    ...
    PROVIDER_TITLE_VIEW = "PROVIDER_TITLE_VIEW",
